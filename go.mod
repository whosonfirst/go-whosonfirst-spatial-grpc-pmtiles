module github.com/whosonfirst/go-whosonfirst-spatial-grpc-pmtiles

go 1.22.3

require (
	github.com/whosonfirst/go-whosonfirst-spatial-grpc v0.1.0
...
require (
	...
	github.com/whosonfirst/go-whosonfirst-spatial v0.9.0 // indirect
